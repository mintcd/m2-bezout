...
Our conjectures include convergence of distributions. We need a way to generate random distributions. In particular, we need to generate random distributions with mean 1.