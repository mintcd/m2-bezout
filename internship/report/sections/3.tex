...
\subsection{Asymptotic when both bounds are at least polynomial}
...
\begin{proposition}
  ...
  Then $T$ is a contraction in the $(\M_p, \ell_p)$ space with $p\ge 2$, where the $\ell_p$ metric is defined by
