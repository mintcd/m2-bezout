...
\tikzset{
  bsquare/.style={rectangle, fill=black, minimum size=10pt, inner sep=0pt},
  bcircle/.style={circle, fill=black, minimum size=10pt, inner sep=0pt},
  brhombus/.style={rectangle, rotate=45, fill=black, minimum size=10pt, inner sep=0pt}
}
...
\titleformat{\section}
{\normalfont\large\bfseries} % style: slightly larger text + bold
{\thesection}                  % section number
{1em}                          % space before text
